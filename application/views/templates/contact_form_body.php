...
<!-- Google Fonts-->
<link href="https://fonts.googleapis.com/css?family=Bitter|Raleway:300|Roboto+Slab:700" rel="stylesheet"> 
<title>A Client's Message From Learnhub Africa</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" mc:repeatable="module1">
	<tr>
		<td align="center" bgcolor="#484443" style="background-color: #484443; background-image: url('http://meraldstar.com/assets/images/img1.jpg'); background-position: center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-position: center center; background-repeat: no-repeat;">
									...
									<table width="140" border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
										<tr>
											<td height="60" valign="middle" width="100%" style="text-align: center;" class="fullCenter" id="box">
												<a href="http://www.learnhub.africa"><img width="100%" src="http://www.learnhub.africa/assets/images/9jaGreenArena_Logo_Icon.png" alt="" border="0" mc:edit="3"></a>
											</td>
										</tr>
									</table>
							...
							<tr>
								<td width="100%" valign="middle" class="image175" align="center">
									...
									<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
										...
										<tr>
											<td valign="middle" width="100%" style="text-align: center; font-family: 'Raleway', sans-serif; font-size: 46px; color: #FFF; line-height: 50px; font-weight: 300;" id="box3" class="fullCenter" mc:edit="4">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" mc:repeatable="module8">
	<tr>
		<td width="100%" valign="top" align="center">
							...
							<tr>
								<td width="100%" class="image191" align="center">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
										<tr>
											<td valign="middle" width="100%" style="text-align: left; font-size: 24px; color: #444444; line-height: 32px; font-weight: 700;" class="fullCenter" mc:edit="45">
												A Client From Learnhub Has Sent You a Message
											</td>
										</tr>
										<tr>
											<td width="100%" height="25"></td>
                                        ...
                                        <tr>
											<td valign="middle" width="100%" style="text-align: left; font-size: 16px; color: #808080; line-height: 22px; font-weight: 400;" class="fullCenter" mc:edit="46">
												<b>Name: </b> <span style="font-family: 'Raleway', sans-serif;"><?php echo $firstName; ?>.</span>
											</td>
										</tr>
                                        <tr>
											<td width="100%" height="25"></td>
                                        ...
                                        <tr>
											<td valign="middle" width="100%" style="text-align: left; font-size: 16px; color: #808080; line-height: 22px; font-weight: 400;" class="fullCenter" mc:edit="46">
												<b>Phone Number: </b> <span style="font-family: 'Raleway', sans-serif;"><?php echo $userPhone; ?>.</span>
											</td>
										</tr>
                                        ...
                                        <tr>
											<td valign="middle" width="100%" style="text-align: left; font-size: 16px; color: #808080; line-height: 22px; font-weight: 400;" class="fullCenter" mc:edit="46">
												<b>Email Address: </b> <span style="font-family: 'Raleway', sans-serif;"><?php echo $userEmail; ?></span>
											</td>
										</tr>
                                        <tr>
											<td width="100%" height="25"></td>
										...
										<tr>
											<td valign="middle" width="100%" style="text-align: left; font-size: 16px; color: #808080; line-height: 22px; font-weight: 400;" class="fullCenter" mc:edit="46">
                                            	<b>Message: </b><br>
												<span style="font-family: 'Raleway', sans-serif;"><?php echo $userMessage; ?></span>
											</td>
										</tr>
										<tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" mc:repeatable="module25">
	<tr>
		<td align="center" width="100%" valign="top" bgcolor="#484443">
							...
							<tr>
								<td width="100%" class="icon30">
									...
									<table width="260" border="0" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="full">
										<tr>
											<td width="100%" style="text-align: left;  font-size: 20px; color: #ffffff; line-height: 28px; font-weight: 700;" class="fullCenter" mc:edit="119">
											
												<a style="text-decoration: none;"><img src="http://www.learnhub.africa/assets/images/9jaGreenArena_Logo_Icon.png" width="30" alt="" border="0" style="vertical-align: middle; padding-bottom: 4px;" mc:edit="120"></a>
												&nbsp;	
												Contact us
											</td>
										</tr>
										...
										<tr>
											<td valign="middle" width="100%" style="text-align: left; font-family: 'Raleway', sans-serif;font-size: 14px; color: #ffffff; line-height: 22px; font-weight: 400;" class="fullCenter" mc:edit="121">
												 G4a Ck Value City Plaza, Warri, Delta State. Nigeria<br><br>
											</td>
										</tr>
									</table>
									...
									<table width="260" border="0" cellpadding="0" cellspacing="0" align="right" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="full">
										<tr>
											<td width="100%" style="text-align: left; font-family: 'Open Sans'; font-size: 20px; color: #ffffff; line-height: 28px; font-weight: 700;" class="fullCenter" mc:edit="122">
											
												<a style="text-decoration: none;"><img src="http://www.learnhub.africa/assets/images/9jaGreenArena_Logo_Icon.png" width="30" alt="" border="0" style="vertical-align: middle; padding-bottom: 4px;" mc:edit="123"></a>
												About us
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td valign="middle" width="100%" style="text-align: left; font-family: 'Raleway', sans-serif;font-size: 14px; color: #ffffff; line-height: 22px; font-weight: 400;" class="fullCenter" mc:edit="124">
												Learnhub Africa is all about Young people; Technology, Entrepreneurship & Lifestyle! We believe in creating the right blend of activities, designed to: Awaken the spirit of creativity & innovation in every Nigerian-African young person..
											</td>
										</tr>
									</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" bgcolor="#484443" mc:repeatable="module26">
	<tr>
				...
				<tr>
					<td width="100%" valign="middle" align="center">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="full">
							...
							<tr>
								<td width="100%" height="1" style="line-height: 1px; font-size: 1px;" bgcolor="#484443">&nbsp;</td>
							</tr>
							<tr>
								<td width="100%" height="25">&nbsp;</td>
							</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" mc:repeatable="module27">
	<tr>
		<td align="center" width="100%" valign="top" bgcolor="#484443">	
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" bgcolor="#484443" mc:repeatable="module28">
	<tr>
		<td width="100%" valign="top" align="center">

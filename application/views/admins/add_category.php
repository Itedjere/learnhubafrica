...
<html lang="en">
<head>
<title>Blog Dashboard :: Add Blog Category</title>
    ...
    <div class="box_padding_all">
        <div class="page-title">
            <div class="title_left">
                <h3><i class="fa fa-home"></i> <a href="index.php">Blog Dashboard</a> / Add Category</h3>
            </div>
        </div>
                ...
                <div class="x_panel container-space">
                    ...
                    <div class="col-sm-6 show_items header-div-6">
                        ...
                        <div class="col-xs-10">
                            ...
                            <a href="<?php echo site_url('Admin/add_tags'); ?>" class="btn btn-success btn-md"> <i class="fa fa-eye"></i> Add New Tags</a>
                        </div>
                    </div>
                        ...
                        <div class="content_body">
                            ...
                            <!--<form class="form-horizontal" role="form">-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">    
                                    	<textarea class="form-control" id="category_description" name="category_description" placeholder"Enter House Description" ></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
